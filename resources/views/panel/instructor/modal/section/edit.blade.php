                ...
                <div class="custom-modal-body ">
                    <form action="{{ @$data['url'] }}" method="post" id="modal_values" enctype="multipart/form-data">
                        ...
                        <div class="ot-contact-form mb-24">
                            ...
                            <input class="ot-contact-input" type="text" name="section_title" id="section_title" value="{{ @$data['section']->title }}"
                        ...
                        <div class="ot-contact-form mb-24 d-none">
                            ...
                            <select class="ot-contact modal_select2" name="section_status" id="section_status">
                                <option value="1" {{ $data['section']->status_id == '1' ? 'selected' : '' }}>{{ ___('common.Active') }}</option>
                                <option value="2" {{ $data['section']->status_id == '2' ? 'selected' : '' }}>{{ ___('common.Inactive') }}</option>
                            </select>
                        </div>
                        <!-- Submit button -->
