                ...
                <div class="custom-modal-body ">
                    <form action="{{ @$data['url'] }}" method="post" id="modal_values" enctype="multipart/form-data">
                        ...
                        <div class="ot-contact-form mb-24">
                            <label class="ot-contact-label">{{ ___('student.Institute') }}
                                <span class="text-danger">*</span>
                            </label>
                            <input class="ot-contact-input" type="text" name="name" id="name"
                                placeholder="{{ ___('student.Daffodil International University') }}">
                        </div>
                        <div class="ot-contact-form mb-24">
                            <label class="ot-contact-label">{{ ___('student.Program') }}<span
                        ...
                        <div class="ot-contact-form mb-24">
                            <label class="ot-contact-label">{{ ___('student.Degree') }}<span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="ot-contact-form mb-24">
                            ...
                            <input class="form-control ot-contact-input datePicker" type="text" name="start_date" id="start_date">
                        </div>
                        <div class="ot-contact-form mb-24">
                            <div class="remember-checkbox mb-30">
                                <label>
                                    <input class="ot-checkbox" type="checkbox" name="current" id="current">
                                    <small class="text-tertiary">{{ ___('student.Currently studying here') }}</small>
                        ...
                        <div class="ot-contact-form mb-24 end_date_div">
                            ...
                            <input class="form-control ot-contact-input datePicker" type="text" name="end_date" id="end_date"
                                placeholder="{{ ___('student.Start Date') }}">
                        </div>
                        <div class="ot-contact-form mb-24">
