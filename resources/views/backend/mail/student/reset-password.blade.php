    ...
    <div class="page-content">
        ...
        <div class="email-template">
            ...
            <div class="template-body">
                ...
                @else
                    <div class="template-btn-container">
                        <a href="{{ route('student.reset_password', [$data->email]) }}" class="template-btn">
                ...
                <div class="content-part">
                    ...
                    <p>
                        <a class="link"
                            href="{{ route('student.reset_password', [$data->email, $data->token]) }}">{{ route('student.reset_password', [$data->email, $data->token]) }}</a>
                    </p>
                    <p>{{ ___('common.if_you_did_not_make_this_request_please_contact_us_or_ignore_this_message') }}
                    </p>
                </div>
