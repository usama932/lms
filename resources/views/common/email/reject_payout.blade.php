        ...
        <div class="email-template">
            ...
            <div class="template-body">
                ...
                <div class="content-part">
                    <p class="ot-primary-text">{{ ___('email.Your payment request has been rejected') }}</p>
                    <p>{{ ___('email.Hello') }} {{ @$data['payout']->user->name }}</p>
                    <p>{{ ___('email.are_receiving_this_email_because_you_have_registered_on_our_site') }}</p>
                    <p> {{ ___('email.click_the_link_below_to_active_your') }} {{ setting('application_name') }}
                        {{ ___('email.account') }} </p>
