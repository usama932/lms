    ...
    <div class="page-content">
        ...
        @include('backend.ui-components.breadcrumb', [
            ...
            'routes' => [
                ...
                route('course.assignment_list.index') => ___('course.Assignment List'),
                '#' => @$data['title'],
            ],
                        ...
                        <table class="table table-bordered">
                            <thead class="thead">
                                <tr>
                                    ...
                                    <th>{{ ___('instructorCommon.Assignment') }}</th>
                            ...
                            <tbody class="tbody">
                                @forelse ($data['submissions'] as $submission)
                                    <tr>
                                        ...
                                        <td>
                                            {{ statusBackend(@$submission->status->class, @$submission->status->name) }}
                                        </td>
                                        <td class="action">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    @if (hasPermission('course_assignment_submission_view'))
                                                        <li>
                                                            <a class="dropdown-item main-modal-open"
                                                                href="javascript:void(0);"
                                                                data-url="{{ route('course.assignment_submission_view.index', $submission->id) }}">
