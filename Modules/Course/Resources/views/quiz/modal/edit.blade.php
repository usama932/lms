                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control ot-input" id="title" name="title"
                                placeholder="{{ ___('course.Title') }}" value="{{ @$data['quiz']->title }}" required />
                            @error('title')
                        ...
                        <div class="col-xl-12 col-md-12 mb-3 video_duration">
                            ...
                            <input type="text" class="form-control ot-input" id="duration" name="duration" required
                                placeholder="20:10:20" value="{{ @$data['quiz']->duration }}" />
                            @error('duration')
                                <div id="validationServer04Feedback" class="invalid-feedback error-show">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-xl-12 col-md-12 mb-3 ">
                            ...
                            <input type="number" class="form-control ot-input" id="marks" name="marks" required
                                placeholder="20:10:20" value="{{ @$data['quiz']->marks }}" />
                            @error('marks')
                                <div id="validationServer04Feedback" class="invalid-feedback error-show">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-xl-12 col-md-12 mb-3">
                            ...
                            <textarea class="form-control ot-input ckeditor-editor" id="instruction" name="instruction" placeholder="{{ ___('course.instruction') }}"><?= @$data['quiz']->instruction ?></textarea>
                            @error('instruction')
                                <div id="validationServer04Feedback" class="invalid-feedback error-show">
                                    {{ $message }}
                                </div>
