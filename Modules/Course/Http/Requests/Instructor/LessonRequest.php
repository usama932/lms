...
class LessonRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'instruction.required' => ___('validation.instruction_is_required'),
            'instruction.max' => ___('validation.instruction_must_be_less_than_1500_characters'),
            ...
            'pass_marks.max' => ___('validation.pass_marks_must_be_less_than_30_characters'),
        ];
    }
}
