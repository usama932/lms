...
class InstallRepository
{
    ...
    public function getPreRequisite()
    {
        ...
        $server[] = $this->check($this->my_version_compare(phpversion(), config('app.php_version', '8.0.2'), '>='), sprintf('Min PHP version ' . config('app.php_version', '8.0.2') . ' (%s)', 'Current Version ' . phpversion()), 'Current Version ' . phpversion(), true);
