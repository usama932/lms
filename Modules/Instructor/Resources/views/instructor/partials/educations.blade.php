            ...
            <div class="col-xl-12">
                <div class="small-tittle-two border-bottom d-flex align-items-center justify-content-between flex-wrap mb-20 pb-8 gap-10">
                    ...
                    <button class="btn btn-lg ot-btn-primary"
                        onclick="mainModalOpen(`{{ route('admin.instructor.addInstitute', @$data['instructor']->user_id) }}`)">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item main-modal-open" href="javascript:;"
                                                    data-url="{{ route('admin.instructor.edit.institute', [$key, @$data['instructor']->user_id]) }}"><span
                                                        class="icon mr-12">
                                            ...
                                            <li>
                                                <a class="dropdown-item delete_data" href="javascript:;"
                                                    data-href="{{ route('admin.instructor.delete.institute', [$key, @$data['instructor']->user_id]) }}"><span
                                                        class="icon mr-12">
