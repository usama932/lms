                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('title') is-invalid @enderror" name="title"
                                        ...
                                        value="{{ @$data['page']->title ?? old('title') }}">
                                    @error('title')
                                ...
                                <div class="col-xl-12 col-md-12 mb-3 page-type-content">
                                    <label for="content" class="form-label ">{{ ___('page.Content') }}<span
                                            class="fillable">*</span></label>
                                    <textarea class="form-control summernote @error('content') is-invalid @enderror" name="content" list="datalistOptions"
                                        rows="20" id="content" placeholder="{{ ___('placeholder.Enter Content') }}"><?= @$data['page']->content ?></textarea>
                                    @error('content')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
