...
@section('content')
    ...
    {{-- breadecrumb Area E n d --}}
        ...
        <div class="card ot-card">
            ...
            <div class="card-body">
                <form action="{{ route('brand.update',$data['brand']->id) }}" enctype="multipart/form-data" method="post">
                    @csrf
                    @method("PUT")
                    {{-- Style Two --}}
                    <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-xl-12 col-md-6">
                                        ...
                                        <div @if (@$data['brand']->iconImage) data-val="{{ (showImage(@$data['brand']->iconImage->original)) }}" @endif
                                    ...
                                    <div class="col-xl-6 col-md-6 mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            placeholder="{{ ___('placeholder.Serial') }}" value="{{ $data['brand']->serial ?? old('serial') }}">
                                        @error('serial')
                                            <div id="validationServer04Feedback" class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-xl-6 col-md-6 mb-3">
                                        ...
                                        <select
                                            ...
                                            <option @if ($data['brand']->status_id  == '1') {{ 'selected' }} @endif
                                                value="1">{{ ___('common.Active') }}</option>
                                            <option @if ($data['brand']->status_id == '2') {{ 'selected' }} @endif
