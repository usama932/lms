        ...
        <div class="table-content table-basic ecommerce-components product-list">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody class="tbody">
                                ...
                                @forelse ($data['galleries'] as $key => $gallery)
                                    <tr>
                                        <td>{{ @$gallery->id }}</td>
                                        <td>{{ Str::limit(@$gallery->title, 20) }}</td>
                                        <td>
                                            <img src="{{ showImage(@$gallery->image->original, 'default-1.jpeg') }}"
                                                alt="{{ @$gallery->name }}" width="35px">
                                        </td>
                                        <td>
                                            {{ statusBackend(@$gallery->status->class, $gallery->status->name) }}
                                        </td>
                                        ...
                                        <td class="action">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    @if (hasPermission('image_gallery_update'))
                                                        <li>
                                                            <a class="dropdown-item main-modal-open"
                                                                href="javascript:void(0);"
                                                                data-url="{{ route('admin.image_gallery.edit', $gallery->id) }}">
                    ...
                    <!--  table end -->
                    <!--  pagination start -->
                    @include('backend.ui-components.pagination', ['data' => $data['galleries']])
                    <!--  pagination end -->
                </div>
            </div>
        </div>
