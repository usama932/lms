                ...
                <form action="{{ $data['url'] }}" method="post" id="modal_values"
                    ...
                    <div class="row mb-3 d-flex justify-content-center">
                        <div class="col-xl-12 col-md-6 mb-3">
                            ...
                            <select
                                class="form-select ot-input modal_select2"
                                id="title" name="title">
                        ...
                        <div class="col-xl-12  mb-3">
                            <label for="color" class="form-label ">{{ ___('common.Color') }} <span
                                    class="fillable">*</span></label>
                            <input class="form-control ot-input @error('color') is-invalid @enderror"
                                name="color" list="datalistOptions" id="color" type="color"
                                placeholder="{{ ___('placeholder.Enter_color') }}">
                        </div>
                        <div class="col-xl-12 col-md-6 mb-3">
