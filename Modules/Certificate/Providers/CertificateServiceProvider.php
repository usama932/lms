...
use Modules\Certificate\Repositories\CertificateGenerateRepository;
use Modules\Certificate\Repositories\CertificateTemplateRepository;
...
class CertificateServiceProvider extends ServiceProvider
{
     ...
     */
    protected $moduleName = 'Certificate';

    /**
     * @var string $moduleNameLower
     */
    protected $moduleNameLower = 'certificate';
    ...
    public function register()
    {
        ...
        $this->app->bind(CertificateGenerateInterface::class,                          CertificateGenerateRepository::class);
    }
